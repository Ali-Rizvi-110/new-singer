...
const AddMusicGallery = () => {
  ...
  const handelClick = async () => {
    ...
    try {
      ...
      if (confirm) {
        const resp = await axios.post("http://localhost:4500/api/gallery/addMusicGallery", formData, {
          headers: {
    ...
    <>
      ...
      <div className="main" style={{ marginTop: "80px" }}>
        <h1 className="text-center mt-5">
          <u> Add Image In Music Gallery</u>
        </h1>
...
export default AddMusicGallery;