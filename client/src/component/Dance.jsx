    ...
    <div>
            ...
            {!show && (
              <div className="imagedata">
                ...
                <i onClick={()=>slideImage(-1, dances.imgArray.length)} className="ri-arrow-drop-left-line fs-1 text-light"></i>
                <img data-aos="zoom-in" src={dances.imgArray[imageIndex]} alt="" className="bdahoja" />
                <i onClick={()=>slideImage(1, dances.imgArray.length)} className="ri-arrow-drop-right-line fs-1 text-light"></i>
                </div>
